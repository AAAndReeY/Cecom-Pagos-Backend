...
try {
    ...
    docXml = replaceInXml(docXml, 'San Juan de Lurigancho, JUNIO del 2026', '{FECHA_DJ}');
    docXml = replaceInXml(docXml, 'San Juan de Lurigancho, JUNIO de 2026', '{FECHA_DJ}');
    docXml = replaceInXml(docXml, 'San Juan de Lurigancho, JUNIO 2026', '{FECHA_DJ}');
    docXml = replaceInXml(docXml, 'JUNIO 2026', '{MES_ANIO}');
